...
const RaceTypeSelect: React.FC<IRaceSelectProps> = ({ selected, titles, competitionsCount, onClick }) => {
    ...
    return (
        <div onClick={onClick} className={`flex items-center w-full lg:min-w-[200px] ${selected ? 'bg-[#FFB54D]' : 'bg-none'} h-md px-4 py-3 rounded-2xl border border-gray-200 cursor-pointer shadow-sm hover:bg-[#FFB54D] transition-all duration-300 ease-in-out transform group`}>
...
const EnvironmentTypeSelect: React.FC<IRaceSelectProps> = ({ selected, titles, competitionsCount, onClick }) => {
    ...
    return (
        <div onClick={onClick} className={`flex items-center w-full lg:min-w-[200px] ${selected ? 'bg-[#419A62]' : 'bg-none'} h-md px-4 py-3 rounded-2xl border border-gray-200 cursor-pointer shadow-sm hover:bg-[#419A62] transition-all duration-300 ease-in-out transform group`}>
            <div className="flex-shrink-0 transition-all duration-300 ease-in-out transform">
...
const EducationTypeSelect: React.FC<IRaceSelectProps> = ({ selected, titles, competitionsCount, onClick }) => {
    ...
    return (
        <div onClick={onClick} className={`flex items-center w-full lg:min-w-[200px] ${selected ? 'bg-[#5D66EA]' : 'bg-none'} h-md px-4 py-3 rounded-2xl border border-gray-200 cursor-pointer shadow-sm hover:bg-[#5D66EA] transition-all duration-300 ease-in-out transform group`}>
            <div className="flex-shrink-0 transition-all duration-300 ease-in-out transform">
...
const IndustryTypeSelect: React.FC<IRaceSelectProps> = ({ selected, titles, competitionsCount, onClick }) => {
    ...
    return (
        <div onClick={onClick} className={`flex items-center w-full lg:min-w-[200px] ${selected ? 'bg-[#57566D]' : 'bg-none'} h-md px-4 py-3 rounded-2xl border border-gray-200 cursor-pointer shadow-sm hover:bg-[#57566D] transition-all duration-300 ease-in-out transform group`}>
            <div className="flex-shrink-0 transition-all duration-300 ease-in-out transform">
...
const TechTypeSelect: React.FC<IRaceSelectProps> = ({ selected, titles, competitionsCount, onClick }) => {
    ...
    return (
        <div onClick={onClick} className={`flex items-center w-full lg:min-w-[200px] ${selected ? 'bg-[#774CDC]' : 'bg-none'} h-md px-4 py-3 rounded-2xl border border-gray-200 cursor-pointer shadow-sm hover:bg-[#774CDC] transition-all duration-300 ease-in-out transform group`}>
            <div className="flex-shrink-0 transition-all duration-300 ease-in-out transform">
